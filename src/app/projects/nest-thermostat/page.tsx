          ...
          <div style={{ display: 'flex', flexDirection: 'column', marginTop: '64px' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '48px 1fr 1fr', gap: '0 48px', alignItems: 'start', padding: '48px 0', borderBottom: '1px solid var(--border)' }} className="reveal d1">
              ...
              <div>
                ...
                <img src="https://res.cloudinary.com/dj13he2xu/image/upload/v1773847849/portfolio/projects/nest-thermostat/01before-r3.png" alt="Before: hidden multi-day interaction" style={{ width: '100%', borderRadius: '14px', display: 'block' }} />
              ...
              <div>
                ...
                <img src="https://res.cloudinary.com/dj13he2xu/image/upload/v1773847850/portfolio/projects/nest-thermostat/01after-r3.png" alt="After: explicit day-selection view modes" style={{ width: '100%', borderRadius: '14px', display: 'block' }} />
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '48px 1fr 1fr', gap: '0 48px', alignItems: 'start', padding: '48px 0', borderBottom: '1px solid var(--border)' }} className="reveal d2">
              ...
              <div>
                <p style={{ fontSize: '11px', fontWeight: 600, letterSpacing: '0.08em', textTransform: 'uppercase', color: 'var(--gray2)', marginBottom: '10px' }}>Before</p>
                <img src="https://res.cloudinary.com/dj13he2xu/image/upload/v1773847851/portfolio/projects/nest-thermostat/02before-r3.png" alt="Before: unclear time to temperature transition" style={{ width: '100%', borderRadius: '14px', display: 'block' }} />
              ...
              <div>
                <p style={{ fontSize: '11px', fontWeight: 600, letterSpacing: '0.08em', textTransform: 'uppercase', color: 'var(--orange)', marginBottom: '10px' }}>After</p>
                <img src="https://res.cloudinary.com/dj13he2xu/image/upload/v1773847851/portfolio/projects/nest-thermostat/02after-r3.png" alt="After: smooth transition and confirmation state" style={{ width: '100%', borderRadius: '14px', display: 'block' }} />
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '48px 1fr 1fr', gap: '0 48px', alignItems: 'start', padding: '48px 0', borderBottom: '1px solid var(--border)' }} className="reveal d3">
              ...
              <div>
                <p style={{ fontSize: '11px', fontWeight: 600, letterSpacing: '0.08em', textTransform: 'uppercase', color: 'var(--gray2)', marginBottom: '10px' }}>Before</p>
                <img src="https://res.cloudinary.com/dj13he2xu/image/upload/v1773847852/portfolio/projects/nest-thermostat/03before-r3.png" alt="Before: color semantic confusion" style={{ width: '100%', borderRadius: '14px', display: 'block' }} />
              ...
              <div>
                <p style={{ fontSize: '11px', fontWeight: 600, letterSpacing: '0.08em', textTransform: 'uppercase', color: 'var(--orange)', marginBottom: '10px' }}>After</p>
                <img src="https://res.cloudinary.com/dj13he2xu/image/upload/v1773847853/portfolio/projects/nest-thermostat/03after-r3.png" alt="After: reserved colors for system states only" style={{ width: '100%', borderRadius: '14px', display: 'block' }} />
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '48px 1fr 1fr', gap: '0 48px', alignItems: 'start', padding: '48px 0' }} className="reveal d4">
              ...
              <div>
                <p style={{ fontSize: '11px', fontWeight: 600, letterSpacing: '0.08em', textTransform: 'uppercase', color: 'var(--gray2)', marginBottom: '10px' }}>Before</p>
                <img src="https://res.cloudinary.com/dj13he2xu/image/upload/v1773847854/portfolio/projects/nest-thermostat/04before-r3.png" alt="Before: mode-first timer flow" style={{ width: '100%', borderRadius: '14px', display: 'block' }} />
              ...
              <div>
                <p style={{ fontSize: '11px', fontWeight: 600, letterSpacing: '0.08em', textTransform: 'uppercase', color: 'var(--orange)', marginBottom: '10px' }}>After</p>
                <img src="https://res.cloudinary.com/dj13he2xu/image/upload/v1773847855/portfolio/projects/nest-thermostat/04after-r3.png" alt="After: direct timer flow" style={{ width: '100%', borderRadius: '14px', display: 'block' }} />
