      ...
      <main className="w-full max-w-[1280px] mx-auto px-6 md:px-[80px] flex flex-col z-10">
        ...
        <section className="relative w-full min-h-screen flex flex-col items-center justify-center pt-20 md:pt-24 text-brand-primary">
          ...
          <a href="#about" className="absolute bottom-12 md:bottom-16 flex flex-col items-center gap-2 opacity-40 hover:opacity-70 transition-opacity text-brand-primary">
            <span className="text-[10px] font-mono tracking-[0.22em] uppercase">向下滚动</span>
        ...
        <section id="about" className="w-full grid grid-cols-1 md:grid-cols-12 gap-[24px] py-32 text-brand-primary">
          ...
          <div className="md:col-span-8 text-base text-brand-primary leading-[1.65] flex flex-col gap-6 font-body">
            <p>
              我最初学的是计算机科学，写出能跑的代码——但总觉得少了什么。当 AI 飞速发展，我意识到瓶颈不再是技术能力本身，而是人与机器之间那个空间。
            </p>
            <p>
          ...
          <div className="md:col-span-8 flex flex-col gap-[64px]">
            ...
            <div className="flex flex-col gap-[40px]">
              ...
              <Link href="/zh/projects/tireswap" className="w-full bg-[#FAFAFA]/90 backdrop-blur-2xl rounded-[16px] overflow-hidden shadow-[0_20px_60px_rgba(27,42,107,0.08)] border border-white/60 flex flex-col group cursor-pointer hover:-translate-y-1 transition-all duration-500">
                ...
                <div className="p-6 md:p-8 flex flex-col gap-4 bg-[#FAFAFA]/90">
                  <div className="flex flex-col gap-2">
                    <h3 className="text-2xl font-bold font-sans text-brand-primary">TireSwap VR <span className="opacity-60 font-normal text-lg">| VR 开发者 & 设计师</span></h3>
                    <p className="text-[16px] md:text-[18px] font-body text-brand-primary/75 leading-relaxed">
                      在真实汽车修理厂环境中手把手教学轮胎更换全流程的 VR 训练模拟，包含步骤引导和程序验证。
                    </p>
                  </div>
                  <div className="flex flex-wrap gap-2">
                    <span className="text-sm font-sans bg-black/5 text-brand-primary/60 px-4 py-1.5 rounded-full uppercase tracking-wider">VR / XR</span>
                    <span className="text-sm font-sans bg-black/5 text-brand-primary/60 px-4 py-1.5 rounded-full uppercase tracking-wider">程序化训练</span>
          ...
          <div className="md:col-span-8 flex flex-col gap-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8">
              <div className="md:col-span-7 rounded-[24px] border border-white/70 bg-white/78 backdrop-blur-xl p-8 shadow-[0_16px_40px_rgba(27,42,107,0.08)] self-start">
                <h3 className="text-xl md:text-2xl font-bold text-brand-primary mb-8">教育背景</h3>
                <div className="flex flex-col gap-8">
                  <div className="flex flex-col md:flex-row gap-3 md:gap-6">
                    <div className="md:w-28 flex-shrink-0 text-sm font-mono text-brand-primary/45 pt-1">2024 — 至今</div>
                    <div className="flex flex-col gap-1.5">
                      <h4 className="text-lg font-bold text-brand-primary">萨凡纳艺术与设计学院</h4>
                      <p className="text-brand-primary/72">交互设计艺术硕士（MFA）</p>
              ...
              <div className="md:col-span-5 flex flex-col gap-6">
                <div className="rounded-[24px] border border-white/70 bg-white/78 backdrop-blur-xl p-8 shadow-[0_16px_40px_rgba(27,42,107,0.08)]">
                  ...
                  <div className="flex flex-wrap gap-2.5">
                    {["Figma", "用户研究", "可用性测试", "交互设计", "设计系统", "原型制作", "JavaScript", "Python", "Unity", "Vibe Coding"].map((skill) => (
                ...
                <div className="rounded-[24px] border border-white/70 bg-white/78 backdrop-blur-xl p-8 shadow-[0_16px_40px_rgba(27,42,107,0.08)]">
                  <h3 className="text-xl md:text-2xl font-bold text-brand-primary mb-6">语言</h3>
